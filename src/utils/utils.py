...
def Create_Similarity_Model(n_nonsimilar, n_similar):
    ...
    for i in range(n_nonsimilar):
        ...
        Phi1_lists_nonsimilar[i] = tf.keras.layers.Dense(1, activation = 'exponential', use_bias = False)(similar_parameters)
    ...
    multiplication_layer = tf.keras.layers.Dense(1, activation = 'exponential', use_bias = False)(similar_parameters)
